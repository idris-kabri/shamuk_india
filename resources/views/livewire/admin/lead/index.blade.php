                                     ...
                                     @foreach ($leads as $lead)
                                         <tr>
                                             ...
                                             <td class="">
                                                 <div class="d-flex px-2 py-1">
                                                     <div class="d-flex flex-column justify-content-center">
                                                         <span class="badge badge-sm bg-gradient-{{ config('app.leads_color')[$lead->status] }} cursor-pointer blink" data-bs-toggle="modal" data-bs-target="#exampleModal">{{ config('app.leads')[$lead->status] }}</span>
                                                     </div>
                                                 </div>
                                             </td>
